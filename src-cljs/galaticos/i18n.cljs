...
(def ^:private dictionary
  {"Unknown error"                                    "Erro desconhecido"
   ...
   "Invalid credentials"                              "Utilizador ou palavra-passe não reconhecidos. Tente novamente."
   "Duplicate entry"                                  "Este registo já existe. Verifique os dados ou edite o existente."
