...
**Workflow:** uma resposta por secção → extrair tarefas para [fp-improvement-checklist.md](../../a-fazer/notebookLM/fp-improvement-checklist.md) → actualizar [fp-design-improvements.md](../../a-fazer/notebookLM/fp-design-improvements.md) → revisar [planos 03–07](../../plans/README.md).
...
6. Preencher **Decisões consolidadas** e seguir [Como extrair tarefas](../../a-fazer/notebookLM/fp-improvement-checklist.md#como-extrair-tarefas-das-respostas)
...
Documentação derivada: [arquitetura-funcional.md](../arquitetura/arquitetura-funcional.md), [fp-improvement-checklist.md](../../a-fazer/notebookLM/fp-improvement-checklist.md), [plans/README.md](../../plans/README.md).
...
- Validar símbolos contra `deps.edn` antes de codificar (ver [auditoria-alucinacoes-ia.md](../qualidade/auditoria-alucinacoes-ia.md)).
