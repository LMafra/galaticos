...
Para evolução de sports data analytics, este documento mantém regras operacionais e funcionais do domínio, enquanto definições semânticas de métricas e contratos devem ser centralizadas na trilha `docs/informacao/analytics`.
...
2. Atualizar catálogo/contrato na trilha `docs/informacao/analytics`.
