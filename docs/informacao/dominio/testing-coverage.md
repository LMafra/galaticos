...
1. Atualizar `docs/informacao/analytics/metrics-catalog.md` e/ou `docs/informacao/analytics/data-contracts.md`.
...
- [ ] Catálogo de métricas atualizado (`docs/informacao/analytics/metrics-catalog.md`).
- [ ] Contrato de dados atualizado (`docs/informacao/analytics/data-contracts.md`) quando houver mudança de schema.
