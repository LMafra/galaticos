...
**Current:** `docs/reference/domain/mongodb-schema.md` already states that `matches` (and `player-statistics` inside them) are the source of truth, and `players.aggregated-stats` is a cache. This is good.
