...
- Contratos de dados estáveis (`data-contracts.md`).
- Runbook de reconciliação (`reconciliation-runbook.md`).
- Estratégia de testes de regressão (`docs/testing-coverage.md`).
