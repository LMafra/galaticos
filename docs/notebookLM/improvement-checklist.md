...
- [ ] Document System of Record vs derived data in [../mongodb-schema.md](../mongodb-schema.md) (matches = source of truth; `players.aggregated-stats` = derived).
...
- [ ] Document indexes and denormalization policy in [../mongodb-schema.md](../mongodb-schema.md).
